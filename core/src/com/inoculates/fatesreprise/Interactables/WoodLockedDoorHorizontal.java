...
public class WoodLockedDoorHorizontal extends LockedDoor {

    public WoodLockedDoorHorizontal(GameScreen screen, TiledMap map, TextureAtlas atlas, Storage storage, float x, float y,
                                    int doorNumber) {
    ...
    protected void chooseSprite() {
        setRegion(atlas.findRegion("ghlockeddoorhorz"));
